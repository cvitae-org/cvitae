      ...
      {education.length === 0 ? (
        ...
        >
          <div className="bg-white px-4 pb-2">
            <EmptySection
              hint="Degree — Institution — Dates"
              onCreate={() => addEntry(locale, "education")}
              label="Add the first qualification"
            />
          </div>
        </MeasuredItem>
      ) : (
            ...
            <div className="group bg-white px-4 pb-2 space-y-1">
              <div className="flex items-start justify-between gap-4">
                <EditableText
                  ...
                  ariaLabel={`Qualification ${index + 1} degree`}
                ...
                <span className="flex items-center gap-1 text-xs text-gray-500 font-cv whitespace-nowrap">
                  <EditableText
                    ...
                    placeholder="Start"
                    ariaLabel={`Qualification ${index + 1} start date`}
                  />
                  ...
                  <EntryControls
                    ...
                    removeLabel={`Remove ${entry.university || "this qualification"}`}
                  />
                </span>
              </div>
              ...
              <EditableText
                ...
                ariaLabel={`Qualification ${index + 1} institution`}
              ...
              <p className="flex flex-wrap items-baseline gap-x-2 text-xs text-gray-500 font-cv">
                <EditableText
                  ...
                  placeholder="Thesis"
                  ariaLabel={`Qualification ${index + 1} thesis`}
                />
                <EditableText
                  value={entry.mark}
                  onCommit={(value) =>
                  ...
                  placeholder="Grade"
                  ariaLabel={`Qualification ${index + 1} grade`}
                />
              </p>
            </div>
          </MeasuredItem>
